export const projects= [
    ...
    {
        src: require("../assets/pics/unsplashClone.jpg"),
        title: "Unsplash clone",
        text: "Web app made with vue with implemenetded hints when searching for pictures",
        git: "https://github.com/hide85x/unsplash-clone",
        live: "https://peaceful-shockley-717712.netlify.app/",
      },
      {
        src: require("../assets/pics/Screenshot_3.jpg"),
     ...
     
      {
        ...
        title: "BaDumTsss",
        text:
          "For all the musicians out there! This website gives you oportunity to lay down some fat beats! ",
